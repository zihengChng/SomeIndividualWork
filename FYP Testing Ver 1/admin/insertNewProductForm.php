 		...
 		<div class="col-md-offset-3 col-md-6">
 			<div class="card-form">
 				...
 				<div class="card-container">
 					<form class="form-horizontal" name="insert-new-product-form" id="insert-new-product-form" method="POST" action="../php/adminphp/insertNewProdct.php" enctype="multipart/form-data">
		 				<div class="form-group">
		 					<label class="control-label col-sm-2" for="productName">Product Name:</label>
		 					<div class="col-sm-10">
		 						<input type="text" name="productName" id="productName" class="form-control" autocomplete="off" required>
		 					</div>
		 				</div>
		 				<div class="form-group">
		 					<label class="control-label col-sm-2" for="prodcutDetail">Product Detail:</label>
		 					<div class="col-sm-10">
		 						<textarea class="form-control textarea-style" name="prodcutDetail" id="prodcutDetail" autocomplete="off" rows="3"></textarea>
		 					</div>
		 				</div>
		 				<div class="form-group">
		 					<label class="control-label col-sm-2" for="productPrice">Product Price:</label>
		 					<div class="col-sm-10">
		 						<input type="number" step="0.05" pattern="[0-9]+([.,][0-9]+)?" name="productPrice" id="productPrice" class="form-control" autocomplete="off" required>
		 					</div>
		 				</div>
		 				<div class="form-group">
							<div class="col-sm-2">
